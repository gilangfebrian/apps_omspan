...
foreach ($this->data as $val) {
    ...
    $kd_d_st = $val->get_kd_d_st();
    $kd_d_st_mas = $val->get_kd_d_st_mas();
    $kd_d_st_file = $val->get_kd_d_st_file();
    ...
    $all = $kd_d_room + $kd_d_jar + $kd_d_con + $kd_d_meet + $kd_d_crew + $kd_d_und + $kd_d_book + $kd_d_absen + $kd_d_absen_crew + $kd_d_st + $kd_d_doc + $kd_d_eval + $kd_d_trans ;
    $all2 = 13;
    $all3 = $all2 - $all;
}
?>
...
: </label></td>
                <td width="10%"><select name="kd_d_room" id="kd_d_room">
                        <?php if ($kd_d_room == 1) {
                            ...
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_room_mas" id="kd_d_room_mas"></textarea></td>
...
: </label></td>
                <td width="10%"><select name="kd_d_jar" id="kd_d_jar">
                        <?php if ($kd_d_jar == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_jar_mas" id="kd_d_jar_mas"></textarea></td>
            ...
            <tr>
                ...
                <td><select name="kd_d_con" id="kd_d_con" >
                        <?php if ($kd_d_con == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_con_mas" id="kd_d_con_mas"></textarea></td>
        ...
        <table width="100%" class="zebra">
            <!--baris pertama-->
            <tr>
                <td><label>Pelaksanaan rapat persiapan training OM SPAN di masing-masing KPPN (Upload Absensi Rapat Format *.RAR) </label></td>
                ...
                <td><select name="kd_d_meet" id="kd_d_meet">
                        <?php if ($kd_d_meet == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_meet_mas" id="kd_d_meet_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_meet_file" id="kd_d_meet_file" size="20" value="<?php echo $kd_d_meet_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
            ...
            <tr>
                <td width="30%"><label>Pembentukan Panitia Pelaksanaan Trainig OM SPAN untuk Pemda (Upload ST Format *.RAR) </label></td>
                <td width="10%"><select name="kd_d_crew" id="kd_d_crew">
                        <?php if ($kd_d_crew == 1) {
                            ?>
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_crew_mas" id="kd_d_crew_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_crew_file" id="kd_d_crew_file" size="20" value="<?php echo $kd_d_crew_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
                        <?php } else {
                            ?>
                            <option value="1" >Selesai</option>
            ...
            <tr>
                <td><label>Penyampaian Undangan Pelaksanaan Training OM SPAN kepada Pemda (Upload Surat Undangan Format *.RAR) </label></td>
                <td><select name="kd_d_und" id="kd_d_und" >
                        <?php if ($kd_d_und == 1) {
                            ?>
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_und_mas" id="kd_d_und_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_und_file" id="kd_d_und_file" size="20" value="<?php echo $kd_d_und_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
                        <?php } else {
                            ?>
                            <option value="1" >Selesai</option>
            ...
            <tr>
                ...
                <td><select name="kd_d_book" id="kd_d_book" >
                        <?php if ($kd_d_book == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_book_mas" id="kd_d_book_mas"></textarea></td>
        ...
        <table width="100%" class="zebra">
            ...
            <tr>
                <td width="30%"><label>Kehadiran Panitia dan Narasumber (Upload Daftar Hadir Panitia dan Narasumber Format *.RAR) </label></td>
                <td width="10%"><select name="kd_d_absen_crew" id="kd_d_absen_crew" >
                        <?php if ($kd_d_absen_crew == 1) {
                            ?>
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_absen_crew_mas" id="kd_d_absen_crew_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_absen_crew_file" id="kd_d_absen_crew_file" size="20" value="<?php echo $kd_d_absen_crew_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
                        <?php } else {
                            ?>
                            <option value="1" >Selesai</option>
            ...
            <tr>
                <td><label>Kehadiran Peserta (Upload Daftar Hadir Peserta Format *.RAR) </label></td>
                <td><select name="kd_d_absen" id="kd_d_absen" >
                        <?php if ($kd_d_absen == 1) {
                            ?>
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_absen_mas" id="kd_d_absen_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_absen_file" id="kd_d_absen_file" size="20" value="<?php echo $kd_d_absen_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
                        <?php } else {
                            ?>
                            <option value="1" >Selesai</option>
            ...
            <tr>
                <td><label>Surat Tugas Peserta (Upload ST Peserta Format *.RAR) </label></td>
                <td><select name="kd_d_st" id="kd_d_st" >
                        <?php if ($kd_d_st == 1) {
                            ?>
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_st_mas" id="kd_d_st_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_st_file" id="kd_d_st_file" size="20" value="<?php echo $kd_d_absen_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
                        <?php } else {
                            ?>
                            <option value="1" >Selesai</option>
                            <option value="0" selected>Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_st_mas" id="kd_d_st_mas"><?php echo $kd_d_st_mas; ?></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_st_file" id="kd_d_st_file" size="20" value="<?php echo $kd_d_absen_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="merah"></div></td>
                            <?php
                        }
            ...
            <tr>
                ...
                <td><select name="kd_d_doc" id="kd_d_doc">
                        <?php if ($kd_d_doc == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_doc_mas" id="kd_d_doc_mas"></textarea></td>
                            <td><input type="text" class="kd_d_tgl" name="kd_d_doc_file" id="kd_d_doc_file" size="20" value="<?php echo $kd_d_doc_file; ?>" placeholder="Format : yyyy-mm-dd"></td>
                            <td width="10%"><div id="bundar" class="hijau"></div></td>
                        <?php } else {
                            ?>
                            <option value="1" >Selesai</option>
    ...
    <div id="komponen4"><i class="icon-folder-open icon-white" id="label"></i>Pasca Training OM SPAN Untuk Pemda</div>
        <table width="100%" class="zebra">
                ...
                <td width="30%"><label>Evaluasi Pelaksanaan Training OM SPAN </label></td>
                    <td width="10%"><select name="kd_d_eval" id="kd_d_eval">
                        <?php if ($kd_d_eval == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea  class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_eval_mas" id="kd_d_eval_mas"></textarea></td>
                ...
                <td><label>Penyaluran DAK dan Dana Desa Tahun 2017 </label></td>
                    <td><select name="kd_d_trans" id="kd_d_trans">
                        <?php if ($kd_d_trans == 1) {
                            ...
                            <option value="1" selected>Selesai</option>
                            <option value="0" >Belum</option>
                            <td><textarea  class="catatan" placeholder="Tambahkan keterangan/catatan disini" rows="3"name="kd_d_trans_mas" id="kd_d_trans_mas"></textarea></td>
            ...
            <input class="biru" type="submit" name="add_DAK" value="SUBMIT" onclick="return ceklvl1();">
...
<script>
	...
	$('#kd_d_st').change(function() {
    opt = $(this).val();
    if (opt=="0") {
        $('textarea' + '#kd_d_st_mas').show();
    }else { 
        $('textarea' + '#kd_d_st_mas').hide();
    }
});
